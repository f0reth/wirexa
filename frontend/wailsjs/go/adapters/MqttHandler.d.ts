...
export function Connect(arg1:adapters.ConnectionConfig):Promise<string>;

export function DeleteProfile(arg1:string):Promise<void>;

export function Disconnect(arg1:string):Promise<void>;

export function GetConnections():Promise<Array<adapters.ConnectionStatus>>;

export function GetProfiles():Promise<Array<adapters.BrokerProfile>>;

export function Publish(arg1:string,arg2:string,arg3:string,arg4:number,arg5:boolean):Promise<void>;

export function SaveProfile(arg1:adapters.BrokerProfile):Promise<void>;
